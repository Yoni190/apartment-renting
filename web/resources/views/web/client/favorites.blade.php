...
<div class="container py-5">
                    ...
                    <div class="card border-0 shadow-sm h-100 rounded-4 overflow-hidden">
                        ...
                        <div class="position-relative">
                            <div class="ratio ratio-16x9 bg-light">
                                @if($apartment && $apartment->images && $apartment->images->count() > 0)
                                    <img src="{{ asset('storage/' . $apartment->images->first()->path) }}" alt="{{ $apartment->title ?? 'Apartment' }}" class="object-fit-cover">
                                @else
                            ...
                            <span class="badge bg-white text-dark shadow-sm rounded-pill position-absolute top-0 end-0 m-3">
                                {{ __('Saved') }}
                            </span>
                        </div>
                        ...
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="mt-auto d-flex gap-2">
                                ...
                                <button type="button" class="btn btn-outline-danger rounded-pill" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $favorite->id }}">
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content rounded-4 border-0 shadow">
                            <div class="modal-body text-center p-4">
                                ...
                                <p class="text-muted small">{{ __('This apartment will be removed from your saved listings.') }}</p>
    ...
    @else
        <div class="empty-state">
            ...
            <p class="text-muted mb-4">{{ __('Start saving apartments you like so you can easily find them later.') }}</p>
